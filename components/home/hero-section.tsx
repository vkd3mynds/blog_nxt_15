  ...
  return (
    ...
    <div className="container relative mx-auto flex h-full flex-col items-center justify-center px-4 py-24 md:flex-row md:py-32">
      ...
      <div className="mt-12 flex-1 md:mt-0">
        <div
          className={cn(
            "relative mx-auto h-64 w-64 md:h-96 md:w-96 rounded-2xl overflow-hidden",
        ...
        >
          <Image
            src="https://images.unsplash.com/photo-1505330622279-bf7d7fc918f4?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8YmxvZ3xlbnwwfHwwfHx8MA%3D%3D"
